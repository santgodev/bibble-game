        ...
        subcategories: [
            {
                ...
                words: [
                    ...
                    { word: 'La Luz', category: 'concepto', difficulty: 'Fácil', description: 'Brilla en medio de las tinieblas.' },
                    { word: 'Tinieblas', category: 'concepto', difficulty: 'Fácil', description: 'La oscuridad espiritual.' },
                    { word: 'El Bautista', category: 'personaje', difficulty: 'Fácil', description: 'La voz que clamaba en el desierto.' },
                    { word: 'El Cordero', category: 'título', difficulty: 'medio', description: 'Aquel que quita el pecado del mundo.' },
                    { word: 'La Paloma', category: 'símbolo', difficulty: 'Fácil', description: 'Forma que tomó el Espíritu Santo.' },
                    { word: 'El Espíritu', category: 'Deidad', difficulty: 'Fácil', description: 'Tercera persona de la Trinidad.' },
                    { word: 'Andrés', category: 'personaje', difficulty: 'medio', description: 'Hermano de Simón Pedro.' },
                    { word: 'Pedro', category: 'personaje', difficulty: 'Fácil', description: 'El apóstol pescador.' },
                    { word: 'Cefas', category: 'título', difficulty: 'Difícil', description: 'Significa "Piedra" en arameo.' },
                    ...
                    { word: 'La Higuera', category: 'lugar', difficulty: 'Difícil', description: 'Donde Jesús vio a Natanael.' },
                    { word: 'El Cielo', category: 'evento', difficulty: 'medio', description: 'Visión prometida a los creyentes.' },
                    { word: 'Los Ángeles', category: 'seres', difficulty: 'medio', description: 'Mensajeros celestiales.' },
                    { word: 'Creyentes', category: 'concepto', difficulty: 'medio', description: 'Potestad dada a los que creen.' },
                    { word: 'Encarnación', category: 'frase', difficulty: 'Difícil', description: 'El misterio de la encarnación.' },
                    { word: 'La Creación', category: 'evento', difficulty: 'Fácil', description: 'Hecha por medio del Verbo.' },
                    { word: 'Israel', category: 'título', difficulty: 'medio', description: 'Confesión de fe de Natanael.' }
                ],
                unleashQuiz: [
            ...
            },
            {
                ...
                image: null,
                words: [
                    'Las Bodas', 'El Vino', 'La Samaritana',
                    'Los Maridos', 'Agua Viva', 'Las Tinajas',
                    'Maestresala', 'El Pozo', 'El Cántaro',
                    'Samaria', 'Los Judíos', 'Adoradores',
                    'En Verdad', 'El Mesías', 'Cosecha Blanca'
                ],
                unleashQuiz: [
            ...
            },
            {
                ...
                image: null,
                words: [
                    'La Piedra', 'No Condeno', 'El Camino',
                    'El Esclavo', 'Tomás', 'La Adúltera',
                    'La Tierra', 'Libre Pecado', 'La Luz',
                    'La Verdad', 'Hijos Abraham', 'La Mentira',
                    'Preparar Lugar', 'La Casa', 'Felipe', 'El Consolador'
                ],
                unleashQuiz: [
            ...
            },
            {
                ...
                image: null,
                words: [
                    'Crucifixión', 'El Sepulcro', 'Magdalena',
                    'Consumado es', 'Las Heridas', 'Pilato',
                    'La Corona', 'Manto Púrpura', 'El Rey',
                    'El Gólgota', 'Suertes', 'La Túnica',
                    'Tengo Sed', 'Arimatea', 'Nicodemo',
                    'Lino Limpio', 'Resurrección', 'Raboni',
                    'El Costado', 'Santo Tomás'
                ],
                unleashQuiz: [
